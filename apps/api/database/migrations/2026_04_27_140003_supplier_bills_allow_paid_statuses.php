...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE supplier_bills ADD CONSTRAINT supplier_bills_status_check CHECK (status IN ('DRAFT', 'APPROVED', 'CANCELLED', 'POSTED', 'PARTIALLY_PAID', 'PAID'))");
    }
